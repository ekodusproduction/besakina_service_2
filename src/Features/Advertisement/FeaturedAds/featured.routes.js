...
featuredRouter.get("/filter", filterAdvertisement)
...
featuredRouter.get("/formdata/fieldname/:fieldname", listFormData)
featuredRouter.post("/formdata", jwtAuth, addFormData)
featuredRouter.put("/formdata/id/:id", jwtAuth, editFormData)
featuredRouter.delete("/formdata/:fieldname/id/:id", jwtAuth, deleteFormData)
